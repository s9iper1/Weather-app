    ...
    request({url, json: true}, (error, response, body) => {
        if(error) {
            ...
            if(body.hasOwnProperty('success')) {
                ...
                callback(undefined, body.current.weather_descriptions[0]+' There is ' +body.current.temperature + ' degree outside and it feels like '+body.current.feelslike+' degree and node '
